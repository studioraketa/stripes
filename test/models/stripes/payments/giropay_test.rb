...
module Stripes
  module Payments
    class GiropayTest < ActiveSupport::TestCase
      def new_order
      ...
      def buil_subject(provider)
        Giropay.new(params: new_params, order: new_order, source_provider: provider)
      end
      ...
      test 'when remote source creation is a success' do
        ...
        assert_equal 'giropay', source.source_type
      ...
      test '.create happy path' do
        ...
        result = Giropay.create(new_params, order)
